...
namespace Pokemon {
    ...
    public delegate IntPtr wglCreateContextAttribsARB(IntPtr hDC, IntPtr hShareContext, uint[] attribList);
    public delegate int wglChoosePixelFormatARB(IntPtr hDC, int[] piAttribIList, float[] pfAttribFList, uint nMaxFormats, out int piFormats, out uint nNumFormats);
    ...
    public delegate uint glShaderSource(uint shader, int count, string[] sources, int[] length);
    ...
    public delegate void glUniformMatrix2fv(int location, int count, int transpose, IntPtr value);
    public delegate void glUniformMatrix3fv(int location, int count, int transpose, IntPtr value);
    public delegate void glUniformMatrix4fv(int location, int count, int transpose, IntPtr value);
    ...
    public delegate void glGenVertexArrays(int n, IntPtr arrays);
    ...
    public delegate void glVertexAttribPointer(uint target, int size, uint type, uint normalized, int stride, int pointer);
    public delegate IntPtr glMapBuffer(uint target, uint access);
    public delegate int glUnmapBuffer(uint target);
    public delegate void glDeleteVertexArrays(int n, uint[] arrays);
    public delegate void glDeleteBuffers(int n, uint[] buffers);

    public delegate void glGenFramebuffers(int n, IntPtr framebuffers);
    ...
    public delegate void glGenRenderbuffers(int n, IntPtr renderbuffers);
    ...
    public unsafe static class OpenGL {
        ...
        private static extern IntPtr glGetStringInternal(uint name);
        public static string glGetString(uint name) { return Marshal.PtrToStringAnsi(glGetStringInternal(name)); }
        ...
        private static extern void glGenTexturesInternal(int n, IntPtr textures);
        public static void glGenTextures(uint[] textures) { fixed(uint* ptr = textures) glGenTexturesInternal(textures.Length, (IntPtr) ptr); }
        public static void glGenTextures(out uint texture) { fixed(uint* ptr = &texture) glGenTexturesInternal(1, (IntPtr) ptr); }

        [DllImport(OPENGL32, CallingConvention = CallingConvention.Cdecl, EntryPoint = "glDeleteTextures")]
        private static extern void glDeleteTexturesInternal(int n, IntPtr textures);
        public static void glDeleteTextures(params uint[] textures) { fixed(uint* ptr = textures) glDeleteTexturesInternal(1, (IntPtr) ptr); }

        [DllImport(OPENGL32, CallingConvention = CallingConvention.Cdecl)]
        public static extern void glGetTexImage(uint target, int level, uint format, uint type, IntPtr pixels);
        public static void glGetTexImage(uint target, int level, uint format, uint type, object pixels) { GCHandle pixelsHandle = GCHandle.Alloc(pixels, GCHandleType.Pinned); try { glGetTexImage(target, level, format, type, pixelsHandle.AddrOfPinnedObject()); } finally { pixelsHandle.Free(); } }
        ...
        public static void glGenVertexArrays(uint[] arrays) { fixed(uint* ptr = arrays) glGenVertexArraysInternal(arrays.Length, (IntPtr) ptr); }
        public static void glGenVertexArrays(out uint array) { fixed(uint* ptr = &array) glGenVertexArraysInternal(1, (IntPtr) ptr); }

        public static void glGenBuffers(uint[] buffers) { fixed(uint* ptr = buffers) glGenBuffersInternal(buffers.Length, (IntPtr) ptr); }
        public static void glGenBuffers(out uint buffer) { fixed(uint* ptr = &buffer) glGenBuffersInternal(1, (IntPtr) ptr); }

        public static void glBufferData(uint target, int size, object data, uint usage) { GCHandle dataHandle = GCHandle.Alloc(data, GCHandleType.Pinned); try { glBufferDataInternal(target, size, dataHandle.AddrOfPinnedObject(), usage); } finally { dataHandle.Free(); } }

        public static void glBufferSubData(uint target, int offset, int size, object data) { GCHandle dataHandle = GCHandle.Alloc(data, GCHandleType.Pinned); try { glBufferSubDataInternal(target, offset, size, dataHandle.AddrOfPinnedObject()); } finally { dataHandle.Free(); } }

        [DllImport(OPENGL32, CallingConvention = CallingConvention.Cdecl)]
        public static extern void glDrawElements(uint mode, int count, uint type, int indices);

        public static void glDeleteVertexArrays(params uint[] arrays) { glDeleteVertexArraysInternal(arrays.Length, arrays); }

        public static void glDeleteBuffers(params uint[] buffers) { glDeleteBuffersInternal(buffers.Length, buffers); }

        public static void glGenFramebuffers(uint[] framebuffers) { fixed(uint* ptr = framebuffers) glGenFramebuffersInternal(framebuffers.Length, (IntPtr) ptr); }
        public static void glGenFramebuffers(out uint framebuffer) { fixed(uint* ptr = &framebuffer) glGenFramebuffersInternal(1, (IntPtr) ptr); }

        public static void glGenRenderbuffers(uint[] renderbuffers) { fixed(uint* ptr = renderbuffers) glGenRenderbuffersInternal(renderbuffers.Length, (IntPtr) ptr); }
        public static void glGenRenderbuffers(out uint renderbuffer) { fixed(uint* ptr = &renderbuffer) glGenRenderbuffersInternal(1, (IntPtr) ptr); }

        public static void glDeleteFramebuffers(params uint[] framebuffers) { glDeleteBuffersInternal(framebuffers.Length, framebuffers); }

        public static void glUniformMat2(int location, int transpose, float[] value) { fixed(float* ptr = value) glUniformMatrix2fvInternal(location, 1, transpose, (IntPtr) ptr); }

        public static void glUniformMat3(int location, int transpose, float[] value) { fixed(float* ptr = value) glUniformMatrix3fvInternal(location, 1, transpose, (IntPtr) ptr); }

        public static void glUniformMat4(int location, int transpose, float[] value) { fixed(float* ptr = value) glUniformMatrix4fvInternal(location, 1, transpose, (IntPtr) ptr); }
        ...
        private static glUniformMatrix2fv glUniformMatrix2fvInternal;
        private static glUniformMatrix3fv glUniformMatrix3fvInternal;
        private static glUniformMatrix4fv glUniformMatrix4fvInternal;
        ...
        private static glGenVertexArrays glGenVertexArraysInternal;
        public static glBindVertexArray glBindVertexArray;
        private static glGenBuffers glGenBuffersInternal;
        public static glBindBuffer glBindBuffer;
        private static glBufferData glBufferDataInternal;
        private static glBufferSubData glBufferSubDataInternal;
        ...
        private static glDeleteVertexArrays glDeleteVertexArraysInternal;
        private static glDeleteBuffers glDeleteBuffersInternal;

        private static glGenFramebuffers glGenFramebuffersInternal;
        public static glBindFramebuffer glBindFramebuffer;
        public static glFramebufferTexture2D glFramebufferTexture2D;
        private static glGenRenderbuffers glGenRenderbuffersInternal;
        ...
        private static glDeleteFramebuffers glDeleteFramebuffersInternal;

        public static void LoadGLExtensions() {
            glActiveTexture = Marshal.GetDelegateForFunctionPointer<glActiveTexture>(wglGetProcAddress("glActiveTexture"));

            glCreateShader = Marshal.GetDelegateForFunctionPointer<glCreateShader>(wglGetProcAddress("glCreateShader"));
            glShaderSource = Marshal.GetDelegateForFunctionPointer<glShaderSource>(wglGetProcAddress("glShaderSource"));
            glCompileShader = Marshal.GetDelegateForFunctionPointer<glCompileShader>(wglGetProcAddress("glCompileShader"));
            glCreateProgram = Marshal.GetDelegateForFunctionPointer<glCreateProgram>(wglGetProcAddress("glCreateProgram"));
            glAttachShader = Marshal.GetDelegateForFunctionPointer<glAttachShader>(wglGetProcAddress("glAttachShader"));
            glLinkProgram = Marshal.GetDelegateForFunctionPointer<glLinkProgram>(wglGetProcAddress("glLinkProgram"));
            glValidateProgram = Marshal.GetDelegateForFunctionPointer<glValidateProgram>(wglGetProcAddress("glValidateProgram"));
            glGetProgramiv = Marshal.GetDelegateForFunctionPointer<glGetProgramiv>(wglGetProcAddress("glGetProgramiv"));
            glGetShaderInfoLog = Marshal.GetDelegateForFunctionPointer<glGetShaderInfoLog>(wglGetProcAddress("glGetShaderInfoLog"));
            glGetProgramInfoLog = Marshal.GetDelegateForFunctionPointer<glGetProgramInfoLog>(wglGetProcAddress("glGetProgramInfoLog"));
            glUseProgram = Marshal.GetDelegateForFunctionPointer<glUseProgram>(wglGetProcAddress("glUseProgram"));
            glGetActiveUniform = Marshal.GetDelegateForFunctionPointer<glGetActiveUniform>(wglGetProcAddress("glGetActiveUniform"));
            glGetUniformLocation = Marshal.GetDelegateForFunctionPointer<glGetUniformLocation>(wglGetProcAddress("glGetUniformLocation"));
            glUniform1f = Marshal.GetDelegateForFunctionPointer<glUniform1f>(wglGetProcAddress("glUniform1f"));
            glUniform2f = Marshal.GetDelegateForFunctionPointer<glUniform2f>(wglGetProcAddress("glUniform2f"));
            glUniform3f = Marshal.GetDelegateForFunctionPointer<glUniform3f>(wglGetProcAddress("glUniform3f"));
            glUniform4f = Marshal.GetDelegateForFunctionPointer<glUniform4f>(wglGetProcAddress("glUniform4f"));
            glUniform1i = Marshal.GetDelegateForFunctionPointer<glUniform1i>(wglGetProcAddress("glUniform1i"));
            glUniform2i = Marshal.GetDelegateForFunctionPointer<glUniform2i>(wglGetProcAddress("glUniform2i"));
            glUniform3i = Marshal.GetDelegateForFunctionPointer<glUniform3i>(wglGetProcAddress("glUniform3i"));
            glUniform4i = Marshal.GetDelegateForFunctionPointer<glUniform4i>(wglGetProcAddress("glUniform4i"));
            glUniformMatrix2fvInternal = Marshal.GetDelegateForFunctionPointer<glUniformMatrix2fv>(wglGetProcAddress("glUniformMatrix2fv"));
            glUniformMatrix3fvInternal = Marshal.GetDelegateForFunctionPointer<glUniformMatrix3fv>(wglGetProcAddress("glUniformMatrix3fv"));
            glUniformMatrix4fvInternal = Marshal.GetDelegateForFunctionPointer<glUniformMatrix4fv>(wglGetProcAddress("glUniformMatrix4fv"));
            glDetachShader = Marshal.GetDelegateForFunctionPointer<glDetachShader>(wglGetProcAddress("glDetachShader"));
            glDeleteShader = Marshal.GetDelegateForFunctionPointer<glDeleteShader>(wglGetProcAddress("glDeleteShader"));
            glDeleteProgram = Marshal.GetDelegateForFunctionPointer<glDeleteProgram>(wglGetProcAddress("glDeleteProgram"));

            glGenVertexArraysInternal = Marshal.GetDelegateForFunctionPointer<glGenVertexArrays>(wglGetProcAddress("glGenVertexArrays"));
            glBindVertexArray = Marshal.GetDelegateForFunctionPointer<glBindVertexArray>(wglGetProcAddress("glBindVertexArray"));
            glGenBuffersInternal = Marshal.GetDelegateForFunctionPointer<glGenBuffers>(wglGetProcAddress("glGenBuffers"));
            glBindBuffer = Marshal.GetDelegateForFunctionPointer<glBindBuffer>(wglGetProcAddress("glBindBuffer"));
            glBufferDataInternal = Marshal.GetDelegateForFunctionPointer<glBufferData>(wglGetProcAddress("glBufferData"));
            glBufferSubDataInternal = Marshal.GetDelegateForFunctionPointer<glBufferSubData>(wglGetProcAddress("glBufferSubData"));
            glEnableVertexAttribArray = Marshal.GetDelegateForFunctionPointer<glEnableVertexAttribArray>(wglGetProcAddress("glEnableVertexAttribArray"));
            glDisableVertexAttribArray = Marshal.GetDelegateForFunctionPointer<glDisableVertexAttribArray>(wglGetProcAddress("glDisableVertexAttribArray"));
            glVertexAttribPointer = Marshal.GetDelegateForFunctionPointer<glVertexAttribPointer>(wglGetProcAddress("glVertexAttribPointer"));
            glMapBuffer = Marshal.GetDelegateForFunctionPointer<glMapBuffer>(wglGetProcAddress("glMapBuffer"));
            glUnmapBuffer = Marshal.GetDelegateForFunctionPointer<glUnmapBuffer>(wglGetProcAddress("glUnmapBuffer"));
            glDeleteVertexArraysInternal = Marshal.GetDelegateForFunctionPointer<glDeleteVertexArrays>(wglGetProcAddress("glDeleteVertexArrays"));
            glDeleteBuffersInternal = Marshal.GetDelegateForFunctionPointer<glDeleteBuffers>(wglGetProcAddress("glDeleteBuffers"));

            glGenFramebuffersInternal = Marshal.GetDelegateForFunctionPointer<glGenFramebuffers>(wglGetProcAddress("glGenFramebuffers"));
            glBindFramebuffer = Marshal.GetDelegateForFunctionPointer<glBindFramebuffer>(wglGetProcAddress("glBindFramebuffer"));
            glFramebufferTexture2D = Marshal.GetDelegateForFunctionPointer<glFramebufferTexture2D>(wglGetProcAddress("glFramebufferTexture2D"));
            glGenRenderbuffersInternal = Marshal.GetDelegateForFunctionPointer<glGenRenderbuffers>(wglGetProcAddress("glGenRenderbuffers"));
            glBindRenderbuffer = Marshal.GetDelegateForFunctionPointer<glBindRenderbuffer>(wglGetProcAddress("glBindRenderbuffer"));
            glRenderbufferStorage = Marshal.GetDelegateForFunctionPointer<glRenderbufferStorage>(wglGetProcAddress("glRenderbufferStorage"));
            glFramebufferRenderbuffer = Marshal.GetDelegateForFunctionPointer<glFramebufferRenderbuffer>(wglGetProcAddress("glFramebufferRenderbuffer"));
            glCheckFramebufferStatus = Marshal.GetDelegateForFunctionPointer<glCheckFramebufferStatus>(wglGetProcAddress("glCheckFramebufferStatus"));
            glDeleteFramebuffersInternal = Marshal.GetDelegateForFunctionPointer<glDeleteFramebuffers>(wglGetProcAddress("glDeleteFramebuffers"));
        }
        ...
        public const  int WGL_CONTEXT_RESET_ISOLATION_BIT_ARB                           = 0x00000008;
        ...
        public const  int WGL_GPU_VENDOR_AMD                                            = 0x1F00;
        public const  int WGL_GPU_RENDERER_STRING_AMD                                   = 0x1F01;
        public const  int WGL_GPU_OPENGL_VERSION_STRING_AMD                             = 0x1F02;
        public const  int WGL_GPU_FASTEST_TARGET_GPUS_AMD                               = 0x21A2;
        public const  int WGL_GPU_RAM_AMD                                               = 0x21A3;
        public const  int WGL_GPU_CLOCK_AMD                                             = 0x21A4;
        public const  int WGL_GPU_NUM_PIPES_AMD                                         = 0x21A5;
        public const  int WGL_GPU_NUM_SIMD_AMD                                          = 0x21A6;
        public const  int WGL_GPU_NUM_RB_AMD                                            = 0x21A7;
        public const  int WGL_GPU_NUM_SPI_AMD                                           = 0x21A8;
        public const  int WGL_TYPE_RGBA_FLOAT_ATI                                       = 0x21A0;
        public const  int WGL_TEXTURE_RECTANGLE_ATI                                     = 0x21A5;
        public const  int WGL_COLORSPACE_EXT                                            = 0x309D;
        public const  int WGL_COLORSPACE_SRGB_EXT                                       = 0x3089;
        public const  int WGL_COLORSPACE_LINEAR_EXT                                     = 0x308A;
        ...
        public const  int WGL_CONTEXT_MULTIGPU_ATTRIB_NV                                = 0x20AA;
        public const  int WGL_CONTEXT_MULTIGPU_ATTRIB_SINGLE_NV                         = 0x20AB;
        public const  int WGL_CONTEXT_MULTIGPU_ATTRIB_AFR_NV                            = 0x20AC;
        public const  int WGL_CONTEXT_MULTIGPU_ATTRIB_MULTICAST_NV                      = 0x20AD;
        public const  int WGL_CONTEXT_MULTIGPU_ATTRIB_MULTI_DISPLAY_MULTICAST_NV        = 0x20AE;
        public const  int WGL_COVERAGE_SAMPLES_NV                                       = 0x2042;
        public const  int WGL_COLOR_SAMPLES_NV                                          = 0x20B9;
        ...
        public const  int WGL_UNIQUE_ID_NV                                              = 0x20CE;
        public const  int WGL_NUM_VIDEO_CAPTURE_SLOTS_NV                                = 0x20CF;
        public const  int WGL_BIND_TO_VIDEO_RGB_NV                                      = 0x20C0;
        public const  int WGL_BIND_TO_VIDEO_RGBA_NV                                     = 0x20C1;
        public const  int WGL_BIND_TO_VIDEO_RGB_AND_DEPTH_NV                            = 0x20C2;
        public const  int WGL_VIDEO_OUT_COLOR_NV                                        = 0x20C3;
        public const  int WGL_VIDEO_OUT_ALPHA_NV                                        = 0x20C4;
        public const  int WGL_VIDEO_OUT_DEPTH_NV                                        = 0x20C5;
        public const  int WGL_VIDEO_OUT_COLOR_AND_ALPHA_NV                              = 0x20C6;
        public const  int WGL_VIDEO_OUT_COLOR_AND_DEPTH_NV                              = 0x20C7;
        public const  int WGL_VIDEO_OUT_FRAME                                           = 0x20C8;
        public const  int WGL_VIDEO_OUT_FIELD_1                                         = 0x20C9;
        public const  int WGL_VIDEO_OUT_FIELD_2                                         = 0x20CA;
        public const  int WGL_VIDEO_OUT_STACKED_FIELDS_1_2                              = 0x20CB;
        public const  int WGL_VIDEO_OUT_STACKED_FIELDS_2_1                              = 0x20CC;
        ...
        public const uint GL_TEXTURE_TILING_EXT                                         = 0x9580;
        public const uint GL_DEDICATED_MEMORY_OBJECT_EXT                                = 0x9581;
        public const uint GL_PROTECTED_MEMORY_OBJECT_EXT                                = 0x959B;
        ...
        public const uint GL_NUM_DEVICE_UUIDS_EXT                                       = 0x9596;
        public const uint GL_DEVICE_UUID_EXT                                            = 0x9597;
        public const uint GL_DRIVER_UUID_EXT                                            = 0x9598;
        public const uint GL_HANDLE_TYPE_OPAQUE_FD_EXT                                  = 0x9586;
        public const uint GL_HANDLE_TYPE_OPAQUE_WIN32_EXT                               = 0x9587;
        public const uint GL_HANDLE_TYPE_OPAQUE_WIN32_KMT_EXT                           = 0x9588;
        public const uint GL_DEVICE_LUID_EXT                                            = 0x9599;
        public const uint GL_DEVICE_NODE_MASK_EXT                                       = 0x959A;
        public const uint GL_HANDLE_TYPE_D3D12_TILEPOOL_EXT                             = 0x9589;
        public const uint GL_HANDLE_TYPE_D3D12_RESOURCE_EXT                             = 0x958A;
        public const uint GL_HANDLE_TYPE_D3D11_IMAGE_EXT                                = 0x958B;
        public const uint GL_HANDLE_TYPE_D3D11_IMAGE_KMT_EXT                            = 0x958C;
        ...
        public const uint GL_LAYOUT_DEPTH_STENCIL_ATTACHMENT_EXT                        = 0x958F;
        public const uint GL_LAYOUT_DEPTH_STENCIL_READ_ONLY_EXT                         = 0x9590;
        public const uint GL_LAYOUT_SHADER_READ_ONLY_EXT                                = 0x9591;
        public const uint GL_LAYOUT_TRANSFER_SRC_EXT                                    = 0x9592;
        public const uint GL_LAYOUT_TRANSFER_DST_EXT                                    = 0x9593;
        public const uint GL_LAYOUT_DEPTH_READ_ONLY_STENCIL_ATTACHMENT_EXT              = 0x9530;
        public const uint GL_LAYOUT_DEPTH_ATTACHMENT_STENCIL_READ_ONLY_EXT              = 0x9531;
        public const uint GL_HANDLE_TYPE_D3D12_FENCE_EXT                                = 0x9594;
        public const uint GL_D3D12_FENCE_VALUE_EXT                                      = 0x9595;
        ...
        public const uint GL_LGPU_SEPARATE_STORAGE_BIT_NVX                              = 0x0800;
        ...
        public const uint GL_PER_GPU_STORAGE_BIT_NV                                     = 0x0800;
